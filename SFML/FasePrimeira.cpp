...
void FasePrimeira::criarInimMedios() {
	entidades::personagens::Inimigo* in1 = new entidades::personagens::Inim_Medio(Vector2f(200.f, 600.f), 1.f, jog);                   //substituir por algo no futuro..
...
void FasePrimeira::criarObsMedios() {
	entidades::obstaculos::Obstaculo* obs1 = new entidades::obstaculos::ObstDificil(Vector2f(400.f, 300.f), Vector2f(400.f, 40.f), false);     //substituir por algo no futuro..
	GC.incluirObstaculo(obs1);
	lista_ents.incluir(obs1);
	entidades::obstaculos::Obstaculo* chao = new entidades::obstaculos::ObstDificil(Vector2f(0.f, 680.f), Vector2f(1280.f, 40.f), false);
